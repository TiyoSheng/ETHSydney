  ...
  <div class="section">
    <div class="section-content">
      ...
      <div class="list flex-center-center">
        ...
        <div class="item flex-center-center">
          <a href="https://hansa.network/" target="_blank"><img src="../assets/images/Hansa.jpg" alt="Hansa"></a>
        </div>
      </div>
      <button>
...
.section-content {
  ...
  button {
    ...
    border-radius: 12px;
    cursor: pointer;
    background: linear-gradient(156deg, #ABF8FF -29%, #CF4DFF 147%);
    box-shadow: 5px 5px 0px 0px #2B2B2B;
    margin: 0 auto;
...
@media screen and (max-width: 768px) {
  .section-content {
    ...
    button {
      ...
      height: 60px;
      border-radius: 10px;
      box-shadow: 4px 4px 0px 0px #2B2B2B;
